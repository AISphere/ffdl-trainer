...
type RatelimitRequest struct {
	...
	Gpus int64 `protobuf:"varint,1,opt,name=gpus" json:"gpus,omitempty" bson:"gpus,omitempty"`
	// Optional. If not specified, assume nvidia-TeslaK80
	// Can only be nvidia-TeslaK80, nvidia-TeslaP100 or nvidia-TeslaV100
	GpuType    string `protobuf:"bytes,2,opt,name=gpu_type,json=gpuType" json:"gpu_type,omitempty" bson:"gpu_type,omitempty"`
	TrainingId string `protobuf:"bytes,3,opt,name=training_id,json=trainingId" json:"training_id,omitempty" bson:"training_id,omitempty"`
	UserId     string `protobuf:"bytes,4,opt,name=user_id,json=userId" json:"user_id,omitempty" bson:"user_id,omitempty"`
	// total number of CPUs requested
	Cpus float32 `protobuf:"fixed32,5,opt,name=cpus" json:"cpus,omitempty" bson:"cpus,omitempty"`
}
...
type RatelimitResponse struct {
	...
	Allowed bool   `protobuf:"varint,1,opt,name=allowed" json:"allowed,omitempty" bson:"allowed,omitempty"`
	Zone    string `protobuf:"bytes,2,opt,name=zone" json:"zone,omitempty" bson:"zone,omitempty"`
}
...
type UpdateResponse struct {
	Success bool `protobuf:"varint,1,opt,name=success" json:"success,omitempty" bson:"success,omitempty"`
}
